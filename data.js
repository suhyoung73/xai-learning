...
const STAR_COLORS = ['#0ea5e9', '#22c55e', '#f97316'];
...
function rawSVM(input) {
    var var0;
    var0 = Math.exp(-0.5000000000000001 * (Math.pow(0.8248931589304704 - input[0], 2.0) + Math.pow(1.319657578205438 - input[1], 2.0)));
    var var1;
    var1 = Math.exp(-0.5000000000000001 * (Math.pow(-0.7351181166195927 - input[0], 2.0) + Math.pow(1.7767227975336652 - input[1], 2.0)));
    var var2;
    var2 = Math.exp(-0.5000000000000001 * (Math.pow(-0.3663094995906722 - input[0], 2.0) + Math.pow(1.4380257503904406 - input[1], 2.0)));
    var var3;
    var3 = Math.exp(-0.5000000000000001 * (Math.pow(-0.7361016062650031 - input[0], 2.0) + Math.pow(1.794302229046289 - input[1], 2.0)));
    var var4;
    var4 = Math.exp(-0.5000000000000001 * (Math.pow(-0.5243562856081323 - input[0], 2.0) + Math.pow(-0.5754051388554411 - input[1], 2.0)));
    var var5;
    var5 = Math.exp(-0.5000000000000001 * (Math.pow(0.8158450541926943 - input[0], 2.0) + Math.pow(-0.5484500105360841 - input[1], 2.0)));
    var var6;
    var6 = Math.exp(-0.5000000000000001 * (Math.pow(0.9761538663945984 - input[0], 2.0) + Math.pow(-0.5566537452419754 - input[1], 2.0)));
    var var7;
    var7 = Math.exp(-0.5000000000000001 * (Math.pow(0.2634189203656419 - input[0], 2.0) + Math.pow(-0.5871247598638571 - input[1], 2.0)));
    var var8;
    var8 = Math.exp(-0.5000000000000001 * (Math.pow(0.5132252902998974 - input[0], 2.0) + Math.pow(-0.5402462758301929 - input[1], 2.0)));
    var var9;
    var9 = Math.exp(-0.5000000000000001 * (Math.pow(2.314093180010981 - input[0], 2.0) + Math.pow(-0.9621526321331716 - input[1], 2.0)));
    var var10;
    var10 = Math.exp(-0.5000000000000001 * (Math.pow(2.2794743444925327 - input[0], 2.0) + Math.pow(-0.7875302791077721 - input[1], 2.0)));
    var var11;
    var11 = Math.exp(-0.5000000000000001 * (Math.pow(-1.1068772025847446 - input[0], 2.0) + Math.pow(-1.250455308940207 - input[1], 2.0)));
    var var12;
    var12 = Math.exp(-0.5000000000000001 * (Math.pow(1.8288393889654626 - input[0], 2.0) + Math.pow(-0.6351752059983631 - input[1], 2.0)));
    var var13;
    var13 = Math.exp(-0.5000000000000001 * (Math.pow(-0.19960800469360013 - input[0], 2.0) + Math.pow(-0.5320425411243016 - input[1], 2.0)));
    var var14;
    var14 = Math.exp(-0.5000000000000001 * (Math.pow(-1.094681930981655 - input[0], 2.0) + Math.pow(-0.4875079812923206 - input[1], 2.0)));
    var var15;
    var15 = Math.exp(-0.5000000000000001 * (Math.pow(0.9481244115004005 - input[0], 2.0) + Math.pow(-0.6047041913764813 - input[1], 2.0)));
    var var16;
    var16 = Math.exp(-0.5000000000000001 * (Math.pow(2.383527548976959 - input[0], 2.0) + Math.pow(-1.0371582065870344 - input[1], 2.0)));
    var var17;
    var17 = Math.exp(-0.5000000000000001 * (Math.pow(0.8591185985907543 - input[0], 2.0) + Math.pow(-0.5736471957041787 - input[1], 2.0)));
    var var18;
    var18 = Math.exp(-0.5000000000000001 * (Math.pow(1.840739613674929 - input[0], 2.0) + Math.pow(-0.551965896838609 - input[1], 2.0)));
    var var19;
    var19 = Math.exp(-0.5000000000000001 * (Math.pow(0.8825256521515231 - input[0], 2.0) + Math.pow(-0.6082200776790061 - input[1], 2.0)));
    var var20;
    var20 = Math.exp(-0.5000000000000001 * (Math.pow(2.487777451390467 - input[0], 2.0) + Math.pow(-0.6035322292756398 - input[1], 2.0)));
    var var21;
    var21 = Math.exp(-0.5000000000000001 * (Math.pow(1.3764341520766534 - input[0], 2.0) + Math.pow(-0.3527323396955357 - input[1], 2.0)));
    var var22;
    var22 = Math.exp(-0.5000000000000001 * (Math.pow(-0.3397552791645899 - input[0], 2.0) + Math.pow(-0.14295112364488793 - input[1], 2.0)));
    var var23;
    var23 = Math.exp(-0.5000000000000001 * (Math.pow(-1.045212401817509 - input[0], 2.0) + Math.pow(0.8564981559528348 - input[1], 2.0)));
    var var24;
    var24 = Math.exp(-0.5000000000000001 * (Math.pow(1.9163699674069932 - input[0], 2.0) + Math.pow(-0.4089865205359329 - input[1], 2.0)));
    var var25;
    var25 = Math.exp(-0.5000000000000001 * (Math.pow(0.5326000363144834 - input[0], 2.0) + Math.pow(-0.27186695473746475 - input[1], 2.0)));
    var var26;
    var26 = Math.exp(-0.5000000000000001 * (Math.pow(0.7519182272410148 - input[0], 2.0) + Math.pow(-0.3035099314601882 - input[1], 2.0)));
    var var27;
    var27 = Math.exp(-0.5000000000000001 * (Math.pow(2.3894284868494218 - input[0], 2.0) + Math.pow(-0.42422202784687374 - input[1], 2.0)));
    var var28;
    var28 = Math.exp(-0.5000000000000001 * (Math.pow(2.1050032813967183 - input[0], 2.0) + Math.pow(-0.38906316482162556 - input[1], 2.0)));
    var var29;
    var29 = Math.exp(-0.5000000000000001 * (Math.pow(0.7186762772261414 - input[0], 2.0) + Math.pow(-0.1722501761659281 - input[1], 2.0)));
    var var30;
    var30 = Math.exp(-0.5000000000000001 * (Math.pow(-1.0010537167385796 - input[0], 2.0) + Math.pow(0.8890787023562315 - input[1], 2.0)));
    var var31;
    var31 = Math.exp(-0.5000000000000001 * (Math.pow(1.5042878059800127 - input[0], 2.0) + Math.pow(-0.3656239228047934 - input[1], 2.0)));
    var var32;
    var32 = Math.exp(-0.5000000000000001 * (Math.pow(1.0194274107926584 - input[0], 2.0) + Math.pow(-0.339840756586278 - input[1], 2.0)));
    var var33;
    var33 = Math.exp(-0.5000000000000001 * (Math.pow(1.124660802851577 - input[0], 2.0) + Math.pow(-0.31874543877112904 - input[1], 2.0)));
    var var34;
    var34 = Math.exp(-0.5000000000000001 * (Math.pow(-0.6348021727877263 - input[0], 2.0) + Math.pow(0.011747873666204231 - input[1], 2.0)));
    var var35;
    var35 = Math.exp(-0.5000000000000001 * (Math.pow(0.23952012198216788 - input[0], 2.0) + Math.pow(-0.1827978350735026 - input[1], 2.0)));
    var var36;
    var36 = Math.exp(-0.5000000000000001 * (Math.pow(2.271409729400167 - input[0], 2.0) + Math.pow(-0.4078145584350912 - input[1], 2.0)));
    var var37;
    var37 = Math.exp(-0.5000000000000001 * (Math.pow(0.4617887818449306 - input[0], 2.0) + Math.pow(-0.23436416751053335 - input[1], 2.0)));
    var var38;
    var38 = Math.exp(-0.5000000000000001 * (Math.pow(0.16575839857638378 - input[0], 2.0) + Math.pow(-0.2624912579307319 - input[1], 2.0)));
    return [0.24985010888267442 + var0 * -1.1463331084268402 + var1 * -0.0 + var2 * -0.0 + var3 * -1.0004249661668074 + var4 * 0.0 + var5 * 0.42776740762860743 + var6 * 0.0 + var7 * 0.0 + var8 * 0.27280003874871256 + var9 * 0.0 + var10 * 0.0 + var11 * 0.2804904221464041 + var12 * 0.0 + var13 * 0.0 + var14 * 0.5008490533444758 + var15 * 0.0 + var16 * 0.15742593066279048 + var17 * 0.0 + var18 * 0.0 + var19 * 0.0 + var20 * 0.5074252220626574, 0.170876555902179 + var21 * -2.0 + var22 * -2.0 + var23 * -0.0 + var24 * -2.0 + var25 * -2.0 + var26 * -2.0 + var27 * -2.0 + var28 * -1.3241687622164078 + var29 * -0.0 + var30 * -0.0 + var31 * -1.9485532406319939 + var32 * -2.0 + var33 * -2.0 + var34 * -2.0 + var35 * -0.1830379123070736 + var36 * -2.0 + var37 * -2.0 + var38 * -2.0 + var4 * 0.7950372637435572 + var5 * 2.0 + var6 * 2.0 + var7 * 1.8644614303169567 + var8 * 2.0 + var9 * 0.7962612210949616 + var10 * 2.0 + var11 * 0.0 + var12 * 2.0 + var13 * 2.0 + var14 * 2.0 + var15 * 2.0 + var16 * 0.0 + var17 * 2.0 + var18 * 2.0 + var19 * 2.0 + var20 * 2.0, -0.3545194459778138 + var21 * -0.0 + var22 * -0.0 + var23 * -0.6719414527286987 + var24 * -0.0 + var25 * -0.0 + var26 * -0.0 + var27 * -0.5176676121542131 + var28 * -0.0 + var29 * -0.7997315875423069 + var30 * -2.0 + var31 * -0.0 + var32 * -0.0 + var33 * -0.0 + var34 * -0.0 + var35 * -0.0 + var36 * -0.0 + var37 * -0.0 + var38 * -0.0 + var0 * 0.9371848512806029 + var1 * 1.487165405085034 + var2 * 1.564990396059582 + var3 * 0.0];
}


function classifyStar(t, mv) {
    const scaled_t = (t - 14704.589285714286) / 10167.8752253935;
    const scaled_mv = (mv - -1.0802410714285715) / 8.532699131498209;
    
    const scores = rawSVM([scaled_t, scaled_mv]);
    let maxIdx = 0;
    for (let i = 1; i < scores.length; i++) {
        if (scores[i] > scores[maxIdx]) maxIdx = i;
    }
    
    const classes = ["거성", "백색왜성", "주계열성"];
...
const LESSONS = {
    ...
    cells: [
      {
        ...
        pseudo: '· meat.csv 파일에서 읽어온 값(read_csv)을 data라는 변수에 저장함',
        code: 'data = pd.read_csv("/content/meat.csv")',
        resultType: 'table'
      },
      {
        id: 2, title: '열 선택하기', stage: '데이터 수집',
        pseudo: '· 그래프의 x축으로 지정할 열 이름(x_col) = 소고기 가격 \n· 그래프의 y축으로 지정할 열 이름(y_col) = 돼지고기 가격 \n\n· 입력값(input) = data에서 x축에 해당하는 열(x_col)에 저장된 값(values)\n· 출력값(output) = data에서 y축에 해당하는 열(y_col)에 저장된 값(values)',
        code: 'x_col = "소고기 가격"\ny_col = "돼지고기 가격"\n\ninput = data[[x_col]].values\noutput = data[y_col].values',
        resultType: 'text'
      },
      {
        id: 3, title: '데이터 시각화하기', stage: '데이터 전처리',
        pseudo: '· 산점도(scatter) = 입력값과 출력값의 쌍으로 이루어진 데이터(input, output)를 점으로 나타낸 그래프',
        code: 'plt.scatter(input, output, alpha=0.6, label="데이터")',
        resultType: 'chart', chartFn: 'drawMeatScatter'
      },
      {
        id: 4, title: '훈련 데이터와 테스트 데이터 분리하기', stage: '데이터 전처리',
        pseudo: '· 훈련 데이터(input, output) = (i_train , o_train) (80%)\n· 테스트 데이터(input, output) = (i_test , o_test) (20%)',
      ...
      },
      {
        ...
        pseudo: '· 모델 이름 = model_a \n· 모델 종류 = 선형 회귀(Linear Regression) \n· 모델을 학습(fit)시킬 데이터 = (i_train, o_train) ',
        code: 'model_a = LinearRegression()\nmodel_a.fit(i_train, o_train)',
        resultType: 'text'
      },
      {
        id: 6, title: '훈련 데이터와 모델 시각화하기', stage: '모델 평가',
        pseudo: '· 산점도(scatter) = 입력값과 출력값의 쌍으로 이루어진 훈련 데이터(i_train, o_train)를 점으로 나타낸 그래프\n· 회귀선(plot) = 모델이 훈련 데이터를 학습해서 예측한 값(model_a.predict)들을 선으로 연결한 그래프',
        code: 'plt.scatter(i_train, o_train, alpha=0.6, label="훈련 데이터")\nplt.plot(x_grid, model_a.predict(x_grid), label="회귀 모델")',
        resultType: 'chart', chartFn: 'drawMeatTrainReg'
      },
      {
        id: 7, title: '테스트 데이터와 모델 시각화하기', stage: '모델 평가',
        pseudo: '· 산점도(scatter) = 훈련 데이터(i_train, o_train)를 파란색 점, 테스트 데이터(i_test, o_test)를 주황색 점으로 나타낸 그래프\n· 회귀선(plot) = 모델이 훈련 데이터를 학습해서 예측한 값(model_a.predict)들을 선으로 연결한 그래프',
      ...
      },
      {
        ...
        pseudo: '· 테스트 데이터의 입력값(i_test)에 대한 모델의 예측값을 y_pred라는 변수에 저장함\n· 테스트 데이터의 입력값(i_test), 실제 출력값(o_test), 모델의 예측값(y_pred)을 표(DataFrame)로 나타냄',
  ...
  4: {
    ...
    cells: [
      {
        id: 1, title: '데이터 불러오기', stage: '데이터 수집',
        pseudo: '· star.csv 파일에서 읽어온 값(read_csv)을 data라는 변수에 저장함',
      ...
      {
        id: 4, title: '훈련 데이터와 테스트 데이터 분리하기', stage: '데이터 전처리',
        pseudo: '· 훈련 데이터(input, output) = (i_train , o_train) (70%)\n· 테스트 데이터(input, output) = (i_test , o_test) (30%)',
